...
public class EditarProducto extends JFrame {
    ...
    private JTextField txtCodigo, txtUnidad, txtUbicacion;
    ...
    public EditarProducto(int idProducto, String usuarioActual, String rolActual) {
        ...
        c.gridx = 0; c.gridy = 6; c.gridwidth = 2; c.weightx = 1.0; c.fill = GridBagConstraints.NONE;
        add(panelBotones, c);
    ...
    private void cargarDatosProducto() {
        String sql = "SELECT codigo_barras, modelo, unidad, ubicacion FROM productos WHERE id = ?";
    ...
    private void guardarCambios(ActionEvent e) {
        ...
        try (Connection con = ConexionDB.conectar()) {
            ...
            String sqlOld = "SELECT codigo_barras, modelo, ubicacion FROM productos WHERE id = ?";
            String codigoAnt = "", descAnt = "", ubicAnt = "";
            ...
            // Actualizar producto
            String sqlUpdate = "UPDATE productos SET codigo_barras = ?, modelo = ?, ubicacion = ? WHERE id = ?";
